        ...
        <div className="row align-items-center">
          ...
          <div className="col-12 col-lg-6">
            <div className="title-wrap margin-bottom-30">
              ...
              <div className="pad-top-15">
                <p className="margin-bottom-20 about-paragraph">
                  {t("about.paragraph1")}
                ...
                {showMore && (
                  <>
                    <p className="margin-bottom-20 about-paragraph">{t("about.paragraph2")}</p>

                    <p className="margin-bottom-20 about-paragraph">{t("about.paragraph3")}</p>
