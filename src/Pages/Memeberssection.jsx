										...
										<div className="card border-0 shadow-sm h-100">
											...
											<div className="card-body text-center">
												...
												<h5 className="text-success fw-bold">
													{t("membersPage.cards.card1.title")}
												</h5>

												<p className="text-muted small">
													{t("membersPage.cards.card1.description")}
												</p>
									...
									<div className="col-md-4 mb-4">
										...
										<div className="card border-0 shadow-sm h-100">
											...
											<div className="card-body text-center">
												...
												<h5 className="text-success fw-bold">
													{t("membersPage.cards.card2.title")}
												</h5>

												<p className="text-muted small">
													{t("membersPage.cards.card2.description")}
												</p>
									...
									<div className="col-md-4 mb-4">
										...
										<div className="card border-0 shadow-sm h-100">
											...
											<div className="card-body text-center">
												...
												<h5 className="text-success fw-bold">
													{t("membersPage.cards.card3.title")}
												</h5>

												<p className="text-muted small">
													{t("membersPage.cards.card3.description")}
												</p>
