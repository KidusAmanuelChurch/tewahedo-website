...
function Mezmursection() {
	const { t } = useTranslation();

	const responsibilities = t("mezmurPage.responsibilities", {
		returnObjects: true,
	});
												...
												<div className="card border-0 shadow-sm h-100">
													...
													<div className="card-body text-center">
														<h5 className="text-success fw-bold">
															{t(`mezmurPage.cards.${card}.title`)}
														</h5>

														<p className="text-muted small">
															{t(`mezmurPage.cards.${card}.description`)}
														</p>
													</div>
												</div>
											</div>
